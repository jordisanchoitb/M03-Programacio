namespace Act40
{
    public partial class Form1 : Form
    {
        ...
        private void GboxMP_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            string mp1 = comboBox1.Text;
            string mp2 = comboBox2.Text;
            string mp3 = comboBox3.Text;
            string mp4 = comboBox4.Text;

            if (mp1 == "" || mp2 == "" || mp3 == "" || mp4 == "")
            {
                MPProvider.SetError(GboxNotas, "Hi han matèries pendents de seleccionar");
                e.Cancel = true;
                return;
            } else if (mp1 == mp2 || mp1 == mp3 || mp1 == mp4 || mp2 == mp3 || mp2 == mp4 || mp3 == mp4)
            {
                MPProvider.SetError(GboxNotas, "Hi ha matèries repetides");
                e.Cancel = true;
                return;
            } 
            MPProvider.SetError(GboxNotas, "");
            e.Cancel = false;
        }
    }
}
